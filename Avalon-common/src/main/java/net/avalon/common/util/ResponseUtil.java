...
public class ResponseUtil {
    ...
    public static R success(AvalonStatus status, Object data) {
        R ret = new R();
    ...
    public static R fail(AvalonException e) {
        R ret = new R();
    ...
    public static R fail(AvalonStatus status) {
        R ret = new R();
        ret.setCode(status.getCode());
        ret.setMessage(status.getMessage());
        return ret;
    ...
    public static R fail(AvalonStatus status, Object data) {
        R ret = new R();
        ret.setCode(status.getCode());
        ret.setMessage(status.getMessage());
        ret.setData(data);
